...
protocol Bars_ConfigureBarsGeoQueryVCDelegate {
    func updateDataForGeoQuery(data: String)
}

class Bars_ConfigureGeoQueryVC: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource  {
