//
//  BuyDrinks_Bars_ConfigureGeoQueryVC.swift
//  Test
//
...
protocol BuyDrinks_Bars_ConfigureBarsGeoQueryVCDelegate {
    func updateDataForGeoQuery(data: String)
}

class BuyDrinks_Bars_ConfigureGeoQueryVC: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource  {
    ...
    var delegate: People_ConfigureGeoQueryVCDelegate?
